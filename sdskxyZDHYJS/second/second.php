...
<body>
    <div class="header">
        ...
        <div class="modules">
            ...
            <div class="module active" onclick="navigateToModule(2)">DC/DC</div>
    ...
    <div class="content">
        <div class="chart-box">
            <div class='chart_title'>压力(pa)</div>
            <div id="chart1" class="chart"></div>
        </div>
        <div class="chart-box">
            <div class='chart_title'>功率(w)</div>
            <div id="chart2" class="chart"></div>
        </div>
        <div class="chart-box">
            <div class='chart_title'>温度(℃)</div>
            <div id="chart3" class="chart"></div>
        </div>
        <div class="chart-box">
            <div class='chart_title'>流量(m3/h)</div>
            <div id="chart4" class="chart"></div>
        </div>
        <div class="chart-box">
            <div class='chart_title'>湿度(%)</div>
            <div id="chart5" class="chart"></div>
        </div>
        <div class="chart-box">
             <div class='chart_title'>纯度(%)</div>
