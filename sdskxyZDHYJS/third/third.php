...
<body>
    <div class="header">
        ...
        <div class="modules">
            ...
            <div class="module active" onclick="navigateToModule(3)">单片燃料电池</div>
    ...
    <div class="content">
        <div class="chart-box">
            <div class='chart_title'>H2流量给定(slpm)</div>
            <div id="chart1" class="chart"></div>
        </div>
        <div class="chart-box">
            <div class='chart_title'>H2背压给定(kpa)</div>
            <div id="chart2" class="chart"></div>
        </div>
        <div class="chart-box">
            <div class='chart_title'>氢气进温度(℃)</div>
            <div id="chart3" class="chart"></div>
        </div>
        <div class="chart-box">
            <div class='chart_title'>氢气出温度(℃)</div>
            <div id="chart4" class="chart"></div>
        </div>
        <div class="chart-box">
            <div class='chart_title'>单片电压V01(V)</div>
            <div id="chart5" class="chart"></div>
        </div>
        <div class="chart-box">
             <div class='chart_title'>单片电压V02(V)</div>
            <div id="chart6" class="chart"></div>
        </div>
        <div class="chart-box">
            <div class='chart_title'>单片电压V03(V)</div>
            <div id="chart7" class="chart"></div>
        </div>
        <div class="chart-box">
             <div class='chart_title'>单片电压V04(V)</div>
